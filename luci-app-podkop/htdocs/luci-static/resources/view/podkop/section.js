...
function createSectionContent(section) {
  ...
  o = section.option(
    ...
    "subscription_url",
    _("Subscription URL"),
    _("Link to your VPN provider's subscription endpoint. Servers are grouped by location and " +
      "refreshed automatically at the interval the subscription itself reports (typically every " +
      "few hours).")
  );
